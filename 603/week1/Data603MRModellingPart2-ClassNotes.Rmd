...
![The graph shows three nonparallel lines](/Users/thunt/OneDrive - University of Calgary/dataset603/interaction.png)
...
```{r}
Advertising=read.table("c:/Users/thunt/OneDrive - University of Calgary/dataset603/Advertising.txt",header = TRUE,  sep ="\t")
interacmodel<-lm(sale~tv+radio+tv*radio, data=Advertising)
summary(interacmodel)

#option2
interacmodell<-lm(sale~(tv+radio)^2, data=Advertising)
summary(interacmodell)
...
Find the best fit model (the interaction term might be included) to predict sales. Which model would you choose? Explain. Once you obtain the best fit model, interpret the regression coefficient for $X_3$
...
```{r}
credit=read.csv("c:/Users/thunt/OneDrive - University of Calgary/dataset603/credit.csv",header = TRUE)
head(credit)
...
![Dummy Coding with three levels](c:/Users/thunt/OneDrive - University of Calgary/dataset603/dummy.png)
...
```{r}
salary=read.csv("c:/Users/thunt/OneDrive - University of Calgary/dataset603/salary.csv",header = TRUE)
head(salary)
...
![Graphs for two quadratic models](c:/Users/thunt/OneDrive - University of Calgary/dataset603/curve.png)
...
aerobicdata=read.csv("c:/Users/thunt/OneDrive - University of Calgary/dataset603/AEROBIC.csv",header = TRUE)
